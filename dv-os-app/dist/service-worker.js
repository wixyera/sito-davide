...
const CACHE_NAME = 'dv-os-shell-atelier-v9';
const DATA_CACHE_NAME = 'dv-os-data-v2';
const APP_SHELL = [
 './','./index.html','./manifest.json','./css/style.css','./css/lab.css','./css/aurora.css','./css/kinetic.css','./css/director.css','./css/atelier.css','./js/director.js','./js/kinetic.js','./js/entrance-scene.js','./assets/backgrounds/chrome-figure.jpg',
