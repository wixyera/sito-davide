...
const CACHE_NAME = 'dv-os-shell-portfolio-v23';
const DATA_CACHE_NAME = 'dv-os-data-v2';
const APP_SHELL = [
 './js/public-theme.js','./js/portfolio-plus.js','./js/press-saved.js','./css/portfolio-plus.css',
 './workspace.html','./letture.html','./js/portfolio-return.js','./js/portfolio.js','./css/portfolio.css','./css/minimal-workspace.css','./js/minimal-workspace.js','./js/press.js','./css/press.css',
 './js/workspace-utils.js','./js/workspace-services.js','./js/workspace-pro.js','./js/workspace-drafts.js','./css/workspace-pro.css',
 './css/gold-edition.css',
 './css/passions.css','./js/outfit-data.js','./js/outfit.js','./js/football.js',
 './css/edition.css','./js/edition.js','./js/public-contact.js','./js/wishlist-details.js',
 './assets/editorial/runway-real-poster.jpg','./assets/editorial/black-gold-poster.jpg','./js/personalization.js','./css/runway.css','./js/runway.js','./css/fashion.css','./js/fashion.js','./assets/editorial/runway.jpg','./','./index.html','./manifest.json','./css/style.css','./css/lab.css','./css/aurora.css','./css/kinetic.css','./css/director.css','./css/atelier.css','./css/product-film.css','./css/orbit-experience.css','./js/orbit-experience.js','./assets/brand/orbit-mark.svg','./js/director.js','./js/kinetic.js','./js/entrance-scene.js','./assets/backgrounds/chrome-figure.jpg',
 ...
 './js/focus-timer.js','./js/gallery.js','./js/museum.js','./assets/earth.jpg',
