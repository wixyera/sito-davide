...
(() => {
 ...
 intro.innerHTML='<div class="cinema-top"><span>DV / SPACE</span><button class="cinema-close" autofocus>Salta intro ↗</button></div><div class="film-stage" aria-hidden="true"><div class="film-light"></div><img class="film-sculpture" src="assets/art/chrome-loop.png" alt=""><div class="film-vignette"></div><div class="film-copy film-one"><span class="film-caption">OGNI MOMENTO CONTA.</span><strong>Il tuo tempo.</strong></div><div class="film-copy film-two"><span class="film-caption">SENZA CONFINI.</span><strong>Le tue idee.</strong></div><div class="film-copy film-three"><strong>Un universo.<br><em>Il tuo.</em></strong></div><div class="film-copy film-end"><span class="film-wordmark">dv<span> / </span>SPACE</span><p>Fai spazio a ciò che sei.</p><span class="film-edition">PERSONAL UNIVERSE — DESIGNED AROUND YOU</span></div><div class="film-footer"><span>DAVIDE VILLANO</span><span>IL TUO SPAZIO. UNA NUOVA PROSPETTIVA.</span></div><div class="film-progress"></div></div><p class="film-accessible">DV SPACE. Il tuo tempo. Le tue idee. Un universo. Il tuo.</p>';
 document.body.append(intro);
 let introTimer;let closing=false;
 function rememberIntro(){try{sessionStorage.setItem('dv-product-film','seen')}catch(_){}}
 ...
 let seen=false;try{seen=sessionStorage.getItem('dv-product-film')==='seen'}catch(_){}
