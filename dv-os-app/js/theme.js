(function(){
  ...
  if (btn) {
    btn.addEventListener('click', function(){
      ...
      if(typeof applyPersonalAppearance==='function')applyPersonalAppearance(normalizedPreferences({...currentUser?.user_metadata?.workspace_preferences,theme:current,accent:readPersonalPreference('accent',currentUser?.user_metadata?.workspace_preferences?.accent||'burgundy'),motion:readPersonalPreference('motion','active')}));
