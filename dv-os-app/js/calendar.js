...
async function loadEvents() {
  reportModuleLoad('calendario','loading');
  ...
  try {
    ...
    reportModuleLoad('calendario','ok');
  } catch (err) {
    reportModuleLoad('calendario','error',err.message);
...
evForm.addEventListener('submit', async e => {
  ...
  try {
    ...
    if(typeof clearWorkspaceDraft==='function')clearWorkspaceDraft('evForm');
    resetEventForm();
    await loadEvents();
    toastSuccess('Evento salvato.');
  } catch (err) {
