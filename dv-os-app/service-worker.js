...
const CACHE_NAME = 'dv-os-shell-runway-v14';
const DATA_CACHE_NAME = 'dv-os-data-v2';
const APP_SHELL = [
 './css/runway.css','./js/runway.js','./js/runway-scene.js','./css/fashion.css','./js/fashion.js','./assets/editorial/runway.jpg','./','./index.html','./manifest.json','./css/style.css','./css/lab.css','./css/aurora.css','./css/kinetic.css','./css/director.css','./css/atelier.css','./css/product-film.css','./css/orbit-experience.css','./js/orbit-experience.js','./assets/brand/orbit-mark.svg','./js/director.js','./js/kinetic.js','./js/entrance-scene.js','./assets/backgrounds/chrome-figure.jpg',
