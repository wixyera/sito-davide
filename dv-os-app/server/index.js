...
const routes={'/api/football-news':{GET:football.onRequestGet},'/api/oracolo':{POST:oracle.onRequestPost},'/api/spotify-search':{GET:spotify.onRequestGet},'/api/fetch-product':{POST:product.onRequestPost}};
export default {
