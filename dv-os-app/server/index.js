...
const routes={'/api/paypal-config':{GET:paypalConfig.onRequestGet},'/api/paypal-order':{POST:paypalOrder.onRequestPost},'/api/product-image':{GET:productImage.onRequestGet},'/api/football-news':{GET:football.onRequestGet},'/api/oracolo':{POST:oracle.onRequestPost},'/api/spotify-search':{GET:spotify.onRequestGet},'/api/fetch-product':{POST:product.onRequestPost}};
export default {
